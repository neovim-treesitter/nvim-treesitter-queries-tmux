# nvim-treesitter-queries-tmux

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tmux/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tmux/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tmux**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tmux",
...
- [ ] Changes are scoped to `tmux` — do not include files for other languages
